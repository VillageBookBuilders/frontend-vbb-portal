...
export const SET_BOOKING_LANGUAGE = 'SET_BOOKING_LANGUAGE';
...
//   return { type: MENTOR_CHANGE };
// };

// export const setBookingLanguage = (language) => {
//   return { type: SET_BOOKING_LANGUAGE, payload: language };
// };
// export const commitChange = () => {
//   return { type: COMMIT_CHANGE };
// };

// /**
//  * Update Booking form, then fetch booking time slots if all options are
//  * selected.
//  */
// export const updatingBookingForm =
//   (optionName, optionValue) => async (dispatch, getState) => {
...
//   return { type: DROPDOWN_CHANGE, payload: { name, value } };
// };
...
//   return { type: SET_TIMES, payload: time };
// };
...
//     dispatch( setLibraryAndLanguageInBooking(
//         getLibraryResponse.data,
//         getLanguageResponse.data
//       )
//     );
//   } catch (err) {
//     // manage what happens when things go wrong
